...
export const questionBank: QuestionCategory[] = [
  ...
  },
  {
    ...
    "questions": [
      {
        "id": "js-comprehensive-01",
        "question": "10.1 JS如何判断一个对象或数组是否为空？",
      ...
      {
        "id": "js-comprehensive-02",
        "question": "10.2 说一下闭包，闭包有什么特点？",
      ...
      {
        "id": "js-comprehensive-03",
        "question": "10.3 内存泄漏怎么理解？",
      ...
      {
        "id": "js-comprehensive-04",
        "question": "10.4 JS中的事件循环 (Event Loop)",
      ...
      {
        "id": "js-comprehensive-05",
        "question": "10.5 AJAX是什么？怎么实现的？",
      ...
      {
        "id": "js-comprehensive-06",
        "question": "10.6 GET和POST的区别",
      ...
      {
        "id": "js-comprehensive-07",
        "question": "10.7 防抖和节流是什么？",
  ...
  },
  {
    ...
    "questions": [
      {
        "id": "ui-components-01",
        "question": "12.1 ECharts有用过吗？常用的配置/组件有哪些？",
      ...
      {
        "id": "ui-components-02",
        "question": "12.2 Element UI 是怎么做表单验证的？",
      ...
      {
        "id": "ui-components-03",
        "question": "12.3 经常用的 Element UI 组件有哪些？",
  ...
  },
  {
    ...
    "questions": [
      {
        "id": "uniapp-01",
        "question": "13.1 uni-app的页面生命周期有哪些？进入或重新进入时执行顺序如何？",
      ...
      {
        "id": "uniapp-02",
        "question": "13.2 在uni-app中实现页面跳转有哪些方式？有什么不同？",
      ...
      {
        "id": "uniapp-03",
        "question": "13.3 uni-app中如何进行条件编译？",
      ...
      {
        "id": "uniapp-04",
        "question": "13.4 uni-app中如何编写路由结构？",
      ...
      {
        "id": "uniapp-05",
        "question": "13.5 uni-app中怎么进行网络请求？",
      ...
      {
        "id": "uniapp-06",
        "question": "13.6 uni-app在页面之间的传值方式有哪些？",
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "question": "14.2 单点登录(SSO)是什么？如何实现？",
